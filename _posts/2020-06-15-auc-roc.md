...
## ROC(Receiver Operator Characteristic curve
  ...
  <img src="https://latex.codecogs.com/svg.latex?\Large&space;specifiity = \frac{True Negatives}{True Negatives + False Positives} \end{equation}" title="\Large specifiity=\frac{True Negatives}{True Negatives + False Positives} \end{equation}" />
...
## Let's create ROC curve from scratch
  ...
  <img src="http://drive.google.com/uc?export=view&id=13De5Yx5Jabbybp5FDX7fl6Re_SxmX_T_" width="300" height="300"/>
    ...
    - calculate TPR and FPR
      <img src="https://latex.codecogs.com/svg.latex?\Large&space;TPR = \frac{5}{5 + 0} \end{equation}" title="\Large TPR=\frac{5}{5 + 0}" />
      <img src="https://latex.codecogs.com/svg.latex?\Large&space;TPR = 1 \end{equation}" title="\Large TPR=1" />
      <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = \frac{4}{4 + 0} \end{equation}" title="\Large FPR=\frac{4}{4 + 0}" />
      <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = 1 \end{equation}" title="\Large FPR=1" />
  ...
  <img src="http://drive.google.com/uc?export=view&id=1vzSyOzx8ApGpKfjtqu7ykGcpLyL3T3fs" width="300" height="300"/>
    ...
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;TPR = 1 \end{equation}" title="\Large TPR=1" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = \frac{1}{1 + 3} \end{equation}" title="\Large FPR=\frac{1}{1 + 3}" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = 0.25 \end{equation}" title="\Large FPR=0.25" />
  ...
  <img src="http://drive.google.com/uc?export=view&id=1uttF_1Y32HEl0ymqXzm9C33djQsHH1zL" width="300" height="300"/>
    ...
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;TPR = 0.8 \end{equation}" title="\Large TPR=0.8" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = \frac{1}{1 + 3} \end{equation}" title="\Large FPR=\frac{1}{1 + 3}" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = 0.25 \end{equation}" title="\Large FPR=0.25" />
  ...
  <img src="http://drive.google.com/uc?export=view&id=1yEOwInpy-U69UvLBdYBZn7TV_ev3INht" width="300" height="300"/>
    ...
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;TPR = 0.6 \end{equation}" title="\Large TPR=0.6" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = \frac{1}{1 + 3} \end{equation}" title="\Large FPR=\frac{1}{1 + 3}" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = 0.25 \end{equation}" title="\Large FPR=0.25" />
  ...
  <img src="http://drive.google.com/uc?export=view&id=11VWx_anYJxqShy_sij__F4lSka1M-bD5" width="300" height="300"/>
    ...
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;TPR = \frac{3}{3 + 2}" title="\Large TPR=\frac{3}{3 + 2}" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;TPR = 0.6 \end{equation}" title="\Large TPR=0.6" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = \frac{0}{0 + 4} \end{equation}" title="\Large FPR=\frac{0}{0 + 4}" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = 0.0 \end{equation}" title="\Large FPR=0.0" />
  ...
  <img src="http://drive.google.com/uc?export=view&id=1RocA8ah5Xg7tcxW4i1KuNqg7dq9W5JXW" width="300" height="300"/>
    ...
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;TPR = 0.4 \end{equation}" title="\Large TPR=0.4" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = \frac{0}{0 + 4} \end{equation}" title="\Large FPR=\frac{0}{0 + 4}" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = 0.0 \end{equation}" title="\Large FPR=0.0" />
  ...
  <img src="http://drive.google.com/uc?export=view&id=1jKU5omxvmT4nvmvxnodB4DfLKeGatNDa" width="300" height="300"/>
    ...
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;TPR = 0.0 \end{equation}" title="\Large TPR=0.0" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = \frac{0}{0 + 4} \end{equation}" title="\Large FPR=\frac{0}{0 + 4}" />
    <img src="https://latex.codecogs.com/svg.latex?\Large&space;FPR = 0.0 \end{equation}" title="\Large FPR=0.0" />
